...
import {ConfirmDeleteSnapshot} from './ConfirmDeleteSnapshot'

export const ButtonSelectSnapshot = ({checkedElements, selected, unCheckedElements, selectAll, reload}) => {
  ...
  return (
    <Dropdown >
      ...
      <Dropdown.Menu>
        ...
        {checkedElements.length === 0?<Dropdown.Item disabled={true}>Delete selected</Dropdown.Item>:<Dropdown.Item disabled={false}><ConfirmDeleteSnapshot reload={reload} checkedElements={checkedElements}/></Dropdown.Item> }
